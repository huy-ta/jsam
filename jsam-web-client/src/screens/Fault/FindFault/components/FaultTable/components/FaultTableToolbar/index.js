...
class FaultTableToolbar extends React.Component {
  state = {
  ...
  render() {
    ...
    let bulkDeleteTooltipTitle = 'Delete selected faults';
    if (bulkDeleteLoading) {
      bulkDeleteTooltipTitle = 'Deleting faults...';
    } else if (bulkDeletePostLoading) {
      if (bulkDeleteSuccess) {
        bulkDeleteTooltipTitle = 'Successfully deleted faults';
      } else {
        bulkDeleteTooltipTitle = "Couldn't delete faults";
      }
    }
...
FaultTableToolbar.propTypes = {
  classes: PropTypes.shape({}).isRequired,
  numSelected: PropTypes.number.isRequired,
  handleBulkDelete: PropTypes.func.isRequired
};

export default withStyles(styles)(FaultTableToolbar);
