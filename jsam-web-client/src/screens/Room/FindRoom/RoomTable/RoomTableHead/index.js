...
const rows = [
  ...
  { id: 'floor', placement: 'bottom-start', disablePadding: false, sortable: true, label: 'Floor' },
  { id: 'capacity', placement: 'bottom-start', disablePadding: false, sortable: true, label: 'Capacity' },
