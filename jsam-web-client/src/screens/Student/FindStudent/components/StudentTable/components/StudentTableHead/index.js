...
const rows = [
  ...
  { id: 'code', placement: 'bottom-start', disablePadding: false, sortable: true, label: 'Student Id' },
  { id: 'gender', placement: 'bottom-start', disablePadding: false, sortable: true, label: 'Gender' },
  { id: 'school', placement: 'bottom-start', disablePadding: false, sortable: true, label: 'School' },
  { id: 'self-phone', placement: 'bottom-start', disablePadding: false, sortable: true, label: 'Self Phone' },
  { id: 'parent-phone', placement: 'bottom-start', disablePadding: false, sortable: true, label: 'Parent Phone' },
  { id: 'status', placement: 'bottom-start', disablePadding: false, sortable: true, label: 'Status' },
