...
const rows = [
  ...
  { id: 'role', placement: 'bottom-start', disablePadding: false, sortable: true, label: 'Role' },
  ...
  { id: 'facebook', placement: 'bottom-start', disablePadding: false, sortable: true, label: 'Facebook' },
...
class TeachingAssistantTableHead extends React.Component {
...
TeachingAssistantTableHead.propTypes = {
  onRequestSort: PropTypes.func.isRequired,
  order: PropTypes.string.isRequired,
  orderBy: PropTypes.string.isRequired
};

export default TeachingAssistantTableHead;
