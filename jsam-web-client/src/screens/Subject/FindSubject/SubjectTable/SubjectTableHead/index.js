...
const rows = [
  ...
  { id: 'teacher-detail', placement: 'bottom-start', disablePadding: false, sortable: true, label: 'Teacher detail' }
];

class SubjectTableHead extends React.Component {
