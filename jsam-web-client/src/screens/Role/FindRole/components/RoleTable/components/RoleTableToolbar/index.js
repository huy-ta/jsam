...
class RoleTableToolbar extends React.Component {
  state = {
  ...
  render() {
    ...
    let bulkDeleteTooltipTitle = "Delete selected roles";
    if (bulkDeleteLoading) {
      bulkDeleteTooltipTitle = "Deleting roles...";
    } else if (bulkDeletePostLoading) {
      if (bulkDeleteSuccess) {
        bulkDeleteTooltipTitle = "Successfully deleted roles";
      } else {
        bulkDeleteTooltipTitle = "Couldn't delete roles";
      }
    }
...
export default withStyles(styles)(RoleTableToolbar);
